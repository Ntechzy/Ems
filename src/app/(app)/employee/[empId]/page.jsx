  ...
  return (
    <div
      className={`bg-gray-100 min-h-screen p-6 ${
        (loading || !employee) && "flex justify-center items-center"
      }`}
    >
      {loading ? (
        <Loader />
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <div className="mt-4 flex space-x-4 text-sm md:text-base">
              ...
              <div>
                ...
                <span
                  className={`text-white font-semibold p-1  md:mt-0 md:p-2 rounded ${
                    employee?.status === "Active"
                      ? "bg-green-500"
                      : "bg-red-500"
                  }`}
              ...
              <div className="bg-white p-6">
                ...
                <ul className="mt-4 space-y-4 text-base">
                  {employee?.software.map((item, index) => (
                    ...
                    >
                      <span className="font-bold text-button_blue">
                        {item.name}:
                      </span>
              ...
              >
                ...
                <form onSubmit={handleSaveAccountDetails} className="mt-4">
                  ...
                  <Input
                    ...
                    handleChange={(e) =>
                      handleInputChange(e, accountDetails, setAccountDetails)
                    }

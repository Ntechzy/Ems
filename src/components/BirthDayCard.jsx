...
const BirthdayCard = ({name,userId}) => {
    ...
    return (
            <Link className="relative h-[400px] w-[400px] flex justify-center items-center shrink-0" href={`/employee/${userId}`}>
                ...
                <div className="bg-trasparent rounded-lg  p-8 text-center w-fit relative z-10">
                    <h1 className="text-[28px] font-light text-gray-600 mb-4 pt-12 drop-shadow-lg">
                        Happy Birthday
                    </h1>
                    <h1 className="text-[28px] font-semibold text-gray-600 mb-4  drop-shadow-lg">
                        {name.split(" ")[0]}
                    </h1>
                </div>
            </Link>
